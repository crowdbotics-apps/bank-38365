"""
Django settings for bank_38365 project.
...
WSGI_APPLICATION = 'bank_38365.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bank_38365 API",
    "DESCRIPTION": "API documentation for bank_38365 App",
    "VERSION": "v1",
}
